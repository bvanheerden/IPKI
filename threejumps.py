...
p0 = [1 / 20, 1 / 1.55, 1 / 550.7, 1 / 17.5, 0.9, 0.1]
...
def modelfunc(t, k1, k2, k3, k4, y0, q0, t_dark, t_light, t_dark2, t_light2, t_dark3):
...
def fittrace(dataset, partnums):
    ...
    def fitfunc(t, k1, k2, k3, k4, y0, q0):
        sol1, sol2, sol3, sol4, sol5, sol6 = modelfunc(t, k1, k2, k3, k4, y0, q0, t_dark,
    ...
    popt, pcov, *extra = curve_fit(fitfunc, t, norm_pulsephotons, p0=p0, bounds=([0, 0, 0, 0, 0.5, 0],
    ...
    return norm_pulsephotons, model, t_plot[:-1], tau1, tau2, tau3, tau4, y0, q0
