...
control, controlfit, t_control = partint(dataset, 3, p0=p0_gco)
# control2 = partint(dataset, 3)
# control3 = partint(dataset, 4)
gco, gcofit, t_gco = partint(dataset, 17, p0=p0_gco)
# gco2 = partint(dataset_gco, 5)
# gco3 = partint(dataset_gco, 6)
aa, aafit, t_aa = partint(dataset, 5, p0=p0_gco)
# aa2 = partint(dataset_aa, 4)
# aa3 = partint(dataset_aa, 5)
ph, phfit, t_ph = partint(dataset, 14)
...
plt.plot(t_gco, gco, '-', label='Low Oxygen')
