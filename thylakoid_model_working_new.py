...
def modelfunc2(t, k1, k2, k3, k4, k5, k7, y0, q0, t_dark):
    ...
    sol1 = solve_ivp(kinetic, [t[0], t[t_dark]], [0, 0, q0, y0], t_eval=t[0:t_dark], args=[k1, k2, k3, k4, k5, k7])
...
def partint(dataset, partnum=1, p0=p0_fast):
    ...
    def fitfunc(t, k1, k2, k3, k4, k5, k7, y0, q0, t_dark_offset):
        return modelfunc2(t, k1, k2, k3, 0, 0, k7, y0, q0, t_dark+int(t_dark_offset*1e10))

    popt, pcov, *extra = curve_fit(fitfunc, t_plot, norm_pulsephotons,
                                   p0=p0, bounds=([0, 0.3, 0.1, 0, 0, 0, 0, 0, -1e-10],
                                   [np.inf, np.inf, np.inf, np.inf, np.inf, np.inf, np.inf, np.inf, 1e-10]),
...
eight, eightfit, t_eight = partint(dataset, 25, p0=p0_fast)
