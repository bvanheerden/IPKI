...
#         ax1.axhline(kr1_aa_val, color='C4', linestyle='--', label=r'$k_{2a}$')
#         ax1.axhline(kr2_aa_val, color='C5', linestyle='--', label=r'$k_{2b}$')
#         ax1.scatter(x_aa, [kr1_aa_val for x in x_aa], color='C4', marker='s', label=None, s=5)
#         ax1.scatter(x_aa, [kr2_aa_val for x in x_aa], color='C5', marker='s', label=None, s=5)
#
#     plot_overlay = False
...
#             Line2D([0], [0], marker='s', color='C4', label=r'$k_{2a}$', linestyle='--', markersize=4),
#             Line2D([0], [0], marker='s', color='C5', label=r'$k_{2b}$', linestyle='--', markersize=4),
#         ])
#     legend_elements.extend([
