...
# dataset = h5py.File('blinking/4 Feb 2025/1500 mE.h5', 'r')
# dataset = h5py.File('blinking/4 Feb 2025/Low pH.h5', 'r')
# dataset = h5py.File('blinking/4 Feb 2025/Low Oxygen New.h5', 'r')
...
def fitfunc(t, k1, k2, k3, k4, k5, y0, t_dark_offset):
    return modelfunc2(t, k1, k2, k3, 0, 1/120, y0, t_dark+int(t_dark_offset*1e9))


popt, pcov = curve_fit(fitfunc, t_plot, norm_pulsephotons, p0=[1/60, 1/20, 1/20, 1/100, 1/120, 1600, 0],
