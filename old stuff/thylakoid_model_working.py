...
def modelfunc2(t, k1, k2, k3, k4, k5, k6, k7, y0, q0, t_dark):
    ...
    sol1 = solve_ivp(kinetic, [t[0], t[t_dark]], [0, 0, q0, y0], t_eval=t[0:t_dark], args=[k1, k2, k3, k4, k6, k7])
...
p0_fast = [1 / 3.63, 1 / 0.64, 1 / 2.6, 1 / 60, 1 / 100, 1 / 800, 1 / 0.6, 0.5, 0.5, 0]
...
def partint(dataset, partnum=1, p0=p0_fast):
    ...
    def fitfunc(t, k1, k2, k3, k4, k5, k6, k7, y0, q0, t_dark_offset):
        return modelfunc2(t, k1, k2, k3, k4, k5, k6, k7, y0, q0, t_dark+int(t_dark_offset*1e9))

    popt, pcov, *extra = curve_fit(fitfunc, t_plot, norm_pulsephotons,
                                   p0=p0, bounds=([0, 0, 1/5, 0, 0, 0, 1, 0, 0, -40e-9],
                                   [np.inf, np.inf, np.inf, np.inf, np.inf, 1/10, np.inf, np.inf, np.inf, 10e-9]),
